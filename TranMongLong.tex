...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubhead
        {Axon}{December. 2020 -- Now}
          {Software Engineer}
          \resumeItemListStart
          \resumeItem{Build Command Hierarchy}
          \resumeItem{Language/Technology: \textbf{Scala} \& \textbf{NodeJs}
          \resumeItemListEnd

    \resumeSubhead
    {Tiki Corporation}{Jul. 2019 -- December. 2020}
      {Software Engineer}
      \resumeItemListStart
